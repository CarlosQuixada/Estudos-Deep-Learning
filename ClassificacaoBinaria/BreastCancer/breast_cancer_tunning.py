...
#OBTER MELHORES PARAMETROS PARA CONFIGURAR A REDE NEURAL
...
classifcador = KerasClassifier(build_fn=criarRede)
...
grid_search = GridSearchCV(estimator=classifcador,param_grid=parametros,scoring='accuracy',cv=5)
